...
.OnConnectionFailedListener, LocationListener {
    ...
    private final static int REQUEST_IP_MULTIPLE_PERMISSION = 0x2;
        ...
        if (permissionLocation != PackageManager.PERMISSION_GRANTED){
            ...
            if (!listPermission.isEmpty()){
                ActivityCompat.requestPermissions(this,
                        listPermission.toArray(new String[listPermission.size()]),REQUEST_IP_MULTIPLE_PERMISSION);
            }
        }
        else {
               getMyLocation();
        ...
        if(mGoogleApiClient!=null) {
            if (mGoogleApiClient.isConnected()) {
                ...
                if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ((PendingResult) result).setResultCallback(new ResultCallback<LocationSettingsResult>() {
